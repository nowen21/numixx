...
class Grocery_crud_model extends CI_Model {
  ...
  /* nuevo busca el elemento y le pasa el valor */

  function set_add_value($field_name, $value) {
    $this->add_values[$field_name] = $value;
  }

  /* nuevo  devuelve el objeto con el nuevo valor */
...
// devuelve todos los campos de la tablas con sus respectivas propiedades
