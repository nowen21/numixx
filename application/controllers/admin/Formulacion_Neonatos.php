...
class Formulacion_Neonatos extends MY_Controller {
    ...
    public function index() {
        ...
        $crud->set_table('formulacion_neonatos');

       // $crud->set_relation('nombre_paciente','pacientes','nombres_apellidos');
        //$crud->set_relation_key('npt', 'pacientesh');
        //$crud->set_relation('npt','pacientesh', 'id');
        //$crud->set_relation('clinica','clinicas','cliente');

        //$crud->where("DATE_ADD('npt','pacientesh', id ) ");
     ...
     // $crud->add_action('osmoralidad', site_url('assets/adminlte/dist/img/credit/cirrus.png'), 'admin/Medicamentos/osmoralidad');
      ...
      //$crud->add_action('unidad_medica', site_url('assets/adminlte/dist/img/credit/cirrus.png'), 'admin/Medicamentos/unidad_medica');
        ...
        $grocery = $crud->render();
        $this->crudver($grocery, 'admin/formulacion_neonatos', 'Formulario Neonatos','crud');
    }
